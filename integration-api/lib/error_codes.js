const errorCodes = [
  ...
  {
    code: 1400,
    message: 'EXISTING_CUD',
    description: 'There is an existing product with that cud, please check the cud parameter',
  },
  {
    code: 2000,
  ...
  {
    code: 2300,
    message: 'FAILED_TO_GET_STATUS',
    description: 'The backend could not retrieve a current status for this order',
  },
];
